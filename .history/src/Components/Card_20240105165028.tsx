            ...
            <Box sx={{ minWidth: 275 }}>
                <Card variant="outlined">
                    ...
                    <div className="container">
                        <div className="silhouette" id="Bulbasaur"><div class="cover"></div></div>
                        <div className="card">
                            <h1>Who's</h1>
                    ...
                    <div className="container">
                        <div className="silhouette" id="Charmander"><div class="cover"></div></div>
                        <div className="card">
                            <h1>That</h1>
                    ...
                    <div className="container">
                        <div className="silhouette" id="Squirtle"><div class="cover"></div></div>
                        <div class="card">
                            <h1>Pokémon?</h1>
